...
- **Low-Poly Round Rock Asset Pack**: Implemented `low_poly_round_rocks` containing 10 distinct, procedurally generated, faceted rounded environmental rock assets (`round_rock_01` through `round_rock_10`) adhering to polygon budgets (<=250 triangles), bottom-center origin, exact dimensions, glTF PBR materials, authoritative `.blend`, inspection layout, preview renders, and clean-scene re-import validation.
